...
import hexdoc_mediaworks

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class MediaworksPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return MediaworksModPlugin(branch=branch)


class MediaworksModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "mediaworks"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_mediaworks, "_templates"
