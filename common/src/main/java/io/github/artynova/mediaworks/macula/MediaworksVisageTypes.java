...
public class MediaworksVisageTypes {
    //    public static final Registrar<VisageType<?>> VISAGE_TYPES = Registry;
//    public static final VisageType<TextVisage> TEXT = VISAGE_TYPES.register("text", () -> TextVisage.TYPE);
